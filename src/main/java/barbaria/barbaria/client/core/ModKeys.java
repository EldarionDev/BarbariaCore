...
public class ModKeys {
    private static final String CATEGORY = "Barbaria Controls";
    private static final String OPEN_FACTION_MENU = "Open the faction menu";
    ...
    public void onKeyPress(InputEvent event) {
        if (FACTION_MENU_KEY.isKeyDown()) {
            Minecraft.getInstance().world.setDayTime(0);
        }
    }
}
